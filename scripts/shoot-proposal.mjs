...
await shoot("04-checklist", { width: 1440, height: 900 }, "#checklist");
await shoot("05-investment", { width: 1440, height: 900 }, "#investment");
await shoot("06-mobile-hero", { width: 390, height: 844 });
await shoot("07-mobile-invest", { width: 390, height: 844 }, "#investment");
